 ...
 * Use the [StartActivityFragment.newInstance] factory method to
...
class StartActivityFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        param1?.let { imageView.setImageResource(it) }
    ...
    companion object {
        ...
        @JvmStatic fun newInstance(param1: Int, param2: String?, param3: String?) =
                StartActivityFragment().apply {
